...
| `lean` | `mathcity-lean` | Lean 4 / Mathlib formalization: the leanpowers router and its 26 leaves — workspace, claim extraction, definition design, statement alignment, proof, diagnosis, verification, source fidelity, style, golfing, generalization, review, Mathlib fit, PR prep. Credits [mathlib-quality](https://github.com/CBirkbeck/mathlib-quality) as prior art. | [README](./subdomains/lean/README.md) | none |
...
| `teaching` | `mathcity-teaching` | Course materials: offerings, syllabi, assessments and keys, course webpages, scanned-notes transcription, lecture-note publication. Routing confers no publication authority. | [README](./subdomains/teaching/README.md) | none |
## Maintenance
