...
| `lean` | `mathcity-lean` | Lean 4 / Mathlib formalization AND the proof-assistant and search surfaces that feed it: the leanpowers and mathpowers routers, Lean workflow leaves, and Stacks / arXiv / Mathlib / scholar search. Absorbed the former `proof-assist` subdomain. Credits [mathlib-quality](https://github.com/CBirkbeck/mathlib-quality) as prior art. | [README](./subdomains/lean/README.md) | none |
