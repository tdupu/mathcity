...
description: Skeleton a discussion or spec into statement stubs in the canonical notes file: claim-shaped items as conjecture environments explicitly marked new (LX4-compatible), definitions as live stubs, statuses agent-side only. Use when the user says "prototype this", "skeleton the discussion into the notes", "rough in the statements". Everything numbered is proposition-class or conjecture — no lemmas. NOT for filling gaps (fill-in-prototype) or polished writing (write-*).
---
