...
- Structure per the house precedents the design record declares:
  separate unnumbered Software and Acknowledgements subsections
  (orderone2 AJMv2.tex:267 pattern) and the contribution-specific AI
  disclosure (jacobi dc2.tex:1709 pattern) — consult those files as
  templates; do not transfer their project-specific grants, thanks, or
  authorship claims.
