...
#: NOT an exclusion, because it is not a tool: `gates_status` (#119) merged
#: `mctl_core/gates.py` and registered NO MCP tool, so the dashboard could not
#: reach it even with permission. Recorded here because this test's first run
#: surfaced it and a comment is cheaper than losing the finding.
