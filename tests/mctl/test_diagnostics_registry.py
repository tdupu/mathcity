...
CODE_PATTERN = re.compile(
    r'"(MBRF\d{3}|MBRF_[A-Z_]+|MCMS_[A-Z_]+|MCOS_[A-Z_]+|MCTL_[A-Z_]+|MDTB\d{3}|MEVT_[A-Z_]+|MGHW_[A-Z_]+|MISS\d{3}|MMAY_[A-Z_]+|MOPT\d{3}|MORD_[A-Z_]+|MQUE_[A-Z_]+|MWKT_[A-Z_]+|MWRK\d{3}|MWRK_[A-Z_]+)"'
)
