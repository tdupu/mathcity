...
def test_the_dashboard_allowlist_contains_no_command_execution_tool():
    ...
    assert len(ALLOWED_TOOLS) == 32  # +commission_brief (#190), +briefs_present (#177), +queue_status (#113), +costs_summary (#118), +worktrees_status (#120), +molecule_cancel (mc-x06e), +tracker_rows (#186), +events_list (#116)
